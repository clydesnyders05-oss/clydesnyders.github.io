 ...
 <nav class="flex items-center justify-between px-6 py-4">
  ...
  <section id="home" class="hero" data-aos="fade-in">
        ...
        <div class="hero-content">
            ...
            <img src="https://github.com/clydesnyders05-oss/clydesnyders.github.io/blob/main/IMG-20250828-WA0021.jpg?raw=true" alt="Portrait of Clyde Snyders" class="mx-auto rounded-lg shadow-md mt-4 w-50 h-64">
